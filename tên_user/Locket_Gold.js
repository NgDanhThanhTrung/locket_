const mapping = {
  ...
  'Locket': ['Gold', 'com.tên_user.premium.yearly']
};
...
const premiumInfo = {
  ...
  original_purchase_date: "yyyy-mm-ddT01:04:17Z",
  purchase_date: "yyyy-mm-ddT01:04:17Z",
  store: "app_store"
};
...
const entitlementInfo = {
  ...
  purchase_date: "yyyy-mm-ddT01:04:17Z",
  product_identifier: "com.tên_user.premium.yearly",
  expires_date: "2999-12-18T01:04:17Z"
};
...
if (match) {
  ...
  let finalSubKey = subKey || "com.tên_user.premium.yearly";
  ...
  obj.subscriber.subscriptions["com.tên_user.premium.yearly"] = premiumInfo;
